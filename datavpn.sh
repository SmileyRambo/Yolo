  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert/cert.crt
        KeyFile: /etc/XrayR/cert/key.key
        Provider: alidns
        Email: test@me.com
        DNSEnv: 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        KeyFile: /etc/XrayR/cert/key.key
        Provider: cloudflare
        Email: tranducanh29122007@gmail.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: tranducanh29122007@gmail.com
          CLOUDFLARE_API_KEY: 1da0db065423b407c6f7335f4ae3b8d869fa6
